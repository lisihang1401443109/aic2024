...
def run_scene(args, scene):
    ...
    for camera in os.listdir(os.path.join(base_directory, scene)):
        ...
        print(cam)
        run_ucmc(args, det_path=base_directory, scene=scene, camera=cam, cam_path='/WAVE/workarea/users/sli13/AIC23_MTPC/data/aic24/test', orig_save_path = '/WAVE/workarea/users/sli13/AIC23_MTPC/UCMCTrack/trk_results')
