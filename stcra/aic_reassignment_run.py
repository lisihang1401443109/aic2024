...
def main():
    ...
    scene_reassign_path = aic[scene]['reassign']
    ...
    cameras = os.listdir(scene_reassign_path)
    ...
    for camera in cameras:
        ...
        with open(cam_file, 'r') as f:
            ...
            for line in lines:
                ...
                output_file.write(f'{camera_number} {global_id} {frame} {x} {y} {w} {h} {x_world} {y_world}\n')
